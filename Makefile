#############################################################################
# Makefile for building: bin/Rolisteam
# Generated by qmake (2.01a) (Qt 4.4.3) on: dim. janv. 25 10:51:26 2009
# Project:  Rolisteam.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.4.3/bin/qmake -spec /usr/local/Trolltech/Qt-4.4.3/mkspecs/linux-g++ -unix CONFIG+=debug_and_release -o Makefile Rolisteam.pro
#############################################################################
...
Makefile: Rolisteam.pro  /usr/local/Trolltech/Qt-4.4.3/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.4.3/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/local/Trolltech/Qt-4.4.3/mkspecs/linux-g++ -unix CONFIG+=debug_and_release -o Makefile Rolisteam.pro
